...
public class TaskExperimentAPI {

    protected static final Logger logger = LoggerFactory.getLogger(TaskExperimentAPI.class);
    ...
    public ResultResp addTaskExperiment(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "add_task_experiment", requestEntity, JsonResult.class);
    ...
    public ResultResp getTaskExperimentByMaster(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonRet> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_task_experiment_by_master", requestEntity, JsonRet.class);
        logger.info("remote call " + s);
    ...
    public ResultResp stopTaskExperiment(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "stop_task_experiment", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp deleteTaskExperiment(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "delete_task_experiment", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp getTaskExperimentByStudent(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonRet> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_task_experiment_by_submitter", requestEntity, JsonRet.class);
    ...
    public ResultResp getTaskDetails(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_task_experiment_details", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp addSimulationAnnex(@RequestBody SimAnnexReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonRet> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "add_simulation_annex", requestEntity, JsonRet.class);
        logger.info("remote call " + s);
        JsonRet resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp taskExperimentProject(@RequestBody ProjectReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "task_experiment_project", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp taskUpload(HttpServletRequest request) throws IOException {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "task_upload", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp saveTaskExperiment(@RequestBody TaskReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "save_task_experiment", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp taskReviewList(@RequestBody TaskScoreReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<List> res1 = restTemplate.postForEntity(Constants.CREATOR_COURSE + "task_review_list", requestEntity, List.class);
    ...
    public ResultResp taskReviewScore(@RequestBody TaskScoreReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "task_review_score", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp getProductName(@RequestBody ProjectNameReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_product_name", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp taskCompleted(@RequestBody TaskExperimentReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "task_completed", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
