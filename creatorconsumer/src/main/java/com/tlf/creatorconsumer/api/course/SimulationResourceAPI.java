...
public class SimulationResourceAPI {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(SimulationResourceAPI.class);
    ...
    public ResultResp getCourseDescription(HttpServletRequest request) {
        ...
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_scene_type_list", requestEntity, JsonResult.class);
    ...
    public ResultResp getSimulationResourceList(@RequestBody SimReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonRet> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_simulation_resource_list", requestEntity, JsonRet.class);
        logger.info("remote call " + s);
    ...
    public ResultResp addSimulationResource(@RequestBody SimulationResourceReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "add_simulation_resource", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp cloneSimulationResource(@RequestBody SimulationResourceReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "clone_simulation_resource", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp deleteSimulationResource(@RequestBody SimulationResourceReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "delete_simulation_resource", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp modifySimulationResource(@RequestBody SimulationResourceReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "modify_simulation_resource", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp getExperimentTypes(HttpServletRequest request) {
        ...
        BaseReq req = TokenUtil.getReq(request);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "experiment_type_list", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
    ...
    public ResultResp getSceneTypeList(@RequestBody SimReq req, HttpServletRequest request) {
        ...
        req.setRole(role);
        HttpEntity<Object> requestEntity = new HttpEntity<>(req, requestHeaders);
        ResponseEntity<JsonResult> s = restTemplate.postForEntity(Constants.CREATOR_COURSE + "get_scene_types", requestEntity, JsonResult.class);
        logger.info("remote call " + s);
        JsonResult resp = s.getBody();
        if (resp.getCode() == 0) {
            return new ResultResp(Constants.CODE_SUCCESS, "SUCCESS", null, resp.getObject());
