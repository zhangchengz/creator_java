...
import com.tlf.creator.po.*;
import com.tlf.creator.service.user.account.IAccountService;
import com.tlf.creator.utils.JWTUtil;
import com.tlf.creator.utils.NetWork;
...
public class AccountServiceImpl implements IAccountService {
    ...
    @Override
    public Map<String, Object> queryAccountByPhone(String phone, String pwd, HttpServletRequest request)   {
    ...
    @Override
    public boolean changePasswordSelf(String id, String pwd, String newPwd)  {
    ...
    @Override
    public List<ClassPO> queryStudentByCourse(String courseId, String teacherId)   {
    ...
    @Override
    public List<Accounts> queryTeachers(Integer offset, Integer limit)  {
    ...
    @Override
    public List<StudentPO> queryStudents(Integer offset, Integer limit)  {
    ...
    @Override
    public void modifyAccount(Accounts account)  {
        accountMapper.updateAccount(account);
    }

    @Override
    public Integer queryTotal(String role)  {
    ...
    @Override
    public Accounts queryAccountById(String id)  {
